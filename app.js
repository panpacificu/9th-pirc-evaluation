(() => {
  ...
  const roundTableQuestions = document.getElementById("roundTableQuestions");
  ...
  const roundTableItems = [
    { name: "roundTableProfessionals", label: "Round Table Discussion — Professionals" },
    { name: "roundTableStudents", label: "Round Table Discussion — Students" }
  ];

  const presentationItems = [
    { name: "facultyPresentations", label: "Faculty Presentations" },
    ...
    { name: "posterSession", label: "Poster Presentation" }
  ];

  const experienceItems = [
    { name: "socializationActivities", label: "Socialization Activities" },
  ...
  function renderStaticQuestions() {
    roundTableQuestions.innerHTML = roundTableItems.map(ratingRow).join("");
  ...
  function validateEmailField() {
    const domain = CONFIG.ALLOWED_EMAIL_DOMAIN || "panpacificu.edu.ph";
    const organizer = CONFIG.ORGANIZER_EMAIL || "pirc@panpacificu.edu.ph";
    ...
    const message = `Use your PanpacificU Email. For outsiders, please contact the organizer, ${organizer}.`;
  ...
  form.addEventListener("submit", async (event) => {
    ...
    if (!validateEmailField()) {
      showMessage("Use your PanpacificU Email. For outsiders, please contact the organizer, pirc@panpacificu.edu.ph.");
